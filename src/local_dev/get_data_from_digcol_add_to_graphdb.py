...
if resumption_token is None:
    ...
    if last_update_timestamp is not None:
        ...
        print('No last update timestamp in graphDB ... default set to 1900-01-01T00:00:00Z')
else: 
...
# get last update timestamp from the graph db
# async with Client(
#         transport=transport,
#         fetch_schema_from_transport=True,
#     ) as session:
...
#     print(result['queryInfoObject'][0]['dateUpdate'])
